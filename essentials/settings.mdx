...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages at [API reference](/api-reference/introduction).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more at the [API reference](/api-reference/introduction)
        </ResponseField>
      </Expandable>
    </ResponseField>
